...
Please note that this version no longer supports Node 8. Node 10 is now the minimum supported version.

### ⚠ BREAKING CHANGES

* Node 8 is no longer supported; Node 10 is now the minimum supported version
